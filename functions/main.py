...
# Initialize Firebase Admin automatically 
...
# =================================================================
# FIREBASE CLOUD FUNCTION SECURITY WRAPPER
# =================================================================

@https_fn.on_request(
    # 1. THE BOTTLENECK: Hard limit to 1 server instance.
    max_instances=1,

    # 2. THE DOMAIN LOCK: Only accept traffic from your specific domains.
    cors=options.CorsOptions(
        cors_origins=[
            "https://lev-katan.web.app", 
            "https://mashiah555.github.io",
            "http://localhost:5000" # Useful if you are testing locally
        ],
        cors_methods=["get", "post", "put", "delete", "options"]
    )
)
def levkatan_api(req: https_fn.Request) -> https_fn.Response:
    """
    This intercepts the HTTPS request from Firebase, applies your security rules,
    and then hands the request off to the Flask application.
    """
